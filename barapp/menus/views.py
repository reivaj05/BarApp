...
class MenuCreateView(
        LoginRequiredMixin, HandleVenueMixin, PermissionRequiredMixin,
...
class MenuDeleteView(
        LoginRequiredMixin, DoesExistMixin, HandleVenueMixin,
        PermissionRequiredMixin, FormMessagesMixin, DeleteView):
...
class MenuUpdateView(
        LoginRequiredMixin, DoesExistMixin, HandleVenueMixin,
        PermissionRequiredMixin, FormMessagesMixin, UpdateView):
